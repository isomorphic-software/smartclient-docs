...
### Description
A message string to use to when displaying an [AsyncOperationResult](../main.md#object-asyncoperationresult) of [type](AsyncOperationResult.md#attr-asyncoperationresulttype) "error" to the user, and no [AsyncOperationResult.errorMessage](AsyncOperationResult.md#attr-asyncoperationresulterrormessage) is available.
...
### Description
A message string to use when displaying an [AsyncOperationResult](../main.md#object-asyncoperationresult) to the user, when the provided [type](AsyncOperationResult.md#attr-asyncoperationresulttype) is neither "error" nor "canceled".
...
### Description
A message string to use when displaying an [AsyncOperationResult](../main.md#object-asyncoperationresult) to the user, when the [type](AsyncOperationResult.md#attr-asyncoperationresulttype) is not provided.
