...
Default implementation will return [ComboBoxItem.generateExactMatchCriteria](#attr-comboboxitemgenerateexactmatchcriteria) if specified, otherwise true if the DataSource for this item [supports advanced criteria](DataSource_1.md#method-datasourcesupportsadvancedcriteria), false if it does not.
