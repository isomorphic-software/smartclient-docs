...
See the [subquery overview](../main.md#object-advancedcriterionsubquery) for more details of the criteria subquery feature, and examples of use.
...
Value may be required or not required, or may be an Array, according to the [OperatorValueType](../main_2.md#type-operatorvaluetype) of the operator.
