...
```
If you use the first signature, you must either specify a callback or if you don't want a callback, pass a `null` as the last argument. The second signature allows you to specify requestParams that are applied to the [RPCRequest](../main.md#object-rpcrequest) generated by this DMI call. This allows you to override some defaults - for example to suppress the "Contacting Server" prompt, change it's text; change the timeout or set any other property settable on [RPCRequest](../main.md#object-rpcrequest).
...
|------|------|----------|---------|-------------|
| appID | [String](#type-string)|[Object](../main.md#type-object) | false | — | the appID (.app.xml file to look in) or comprehensive request object as documented above. |
...
```
The second signature allows you to specify requestParams that are applied to the [RPCRequest](../main.md#object-rpcrequest) generated by this DMI call.
