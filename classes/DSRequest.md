...
### Description
If set to "true", all criteria for the DSRequest using [serverSummaries](../kb_topics/serverSummaries.md#kb-topic-server-summaries) are applied before aggregation, and the [afterWhereClause](OperationBinding.md#attr-operationbindingafterwhereclause) is not generated.
