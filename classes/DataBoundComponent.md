...
---
## Attr: DataBoundComponent.adminSearches

### Description
Controls how the component combines saved search admin records from the [Saved Search DataSource](SavedSearches.md#method-savedsearchesgetsavedsearchdatasource) with those declared locally in the property [DataBoundComponent.adminSavedSearches](#attr-databoundcomponentadminsavedsearches).
...
---
## Attr: DataBoundComponent.adminSavedSearches

### Description
Locally stored [saved search admin](SavedSearches.md#class-savedsearches) records that are avaliable to the component, and may be used in combination with those fetched from the saved search DataSource, following the policy in the [DataBoundComponent.adminSearches](#attr-databoundcomponentadminsearches) setting.

The fields in these records should match those of the [Saved Search DataSource](SavedSearches.md#method-savedsearchesgetsavedsearchdatasource).
...
---
## Attr: DataBoundComponent.autoFetchFullRecord

### Description
Controls whether [DynamicForm.editSelectedData](DynamicForm.md#method-dynamicformeditselecteddata) and [DataBoundComponent.viewSelectedData](#method-databoundcomponentviewselecteddata) automatically fetch complete records from the server when the selection component uses [ListGrid.fetchFields](ListGrid_1.md#attr-listgridfetchfields). When [ListGrid.fetchFields](ListGrid_1.md#attr-listgridfetchfields) is active, selected records may contain only the subset of field values that were fetched — enabling this property causes a primary-key lookup to retrieve all field values before editing or viewing.

Defaults to true when unset. Set to `false` to skip the server round-trip and use locally available (possibly partial) record data.
...
| Name | Type | Optional | Default | Description |
|------|------|----------|---------|-------------|
| hiliteID | [Identifier](../reference_2.md#type-identifier) | false | — | ID of hilite to enable |
...
| Name | Type | Optional | Default | Description |
|------|------|----------|---------|-------------|
| hiliteID | [Identifier](../reference_2.md#type-identifier) | false | — | ID of hilite to disable |
