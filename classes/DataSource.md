...
*   a top-level "and" or "or" [Criterion](../reference.md#object-criterion), where none of the [subcriteria](Criterion.md#attr-criterioncriteria) use [logical operators](../reference.md#type-logicaloperator), hence have no subcriteria of their own
