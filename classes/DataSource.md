...
Unlike the [DataSource.defaultStringInBrowser](#classattr-datasourcedefaultstringinbrowser) class default, this attribute applies when using the SmartClient Server.
