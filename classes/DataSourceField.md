...
### Description
For a DataSource with [serverType](DataSource.md#attr-datasourceservertype) "sql" or "hibernate", indicates that this field should be omitted by default from all SQL or Hibernate operations, and will only be used with [custom queries](../kb_topics/customQuerying.md#kb-topic-custom-querying-overview).
