...
`[Object](../reference.md#type-object)|[String](#type-string)` — JSON Schema object, or a JSON string if [JSONSchemaSettings.asString](JSONSchemaSettings.md#attr-jsonschemasettingsasstring) is true.
