...
| Name | Type | Optional | Default | Description |
|------|------|----------|---------|-------------|
| hour | [int](../reference.md#type-int) | false | — | hour (0-23) |
| minute | [int](../reference.md#type-int) | false | — | minute (0-59) |
| second | [int](../reference.md#type-int) | false | — | second (0-59) |
...
| Name | Type | Optional | Default | Description |
|------|------|----------|---------|-------------|
| year | [int](../reference.md#type-int) | false | — | full year |
| month | [int](../reference.md#type-int) | false | — | month (zero based, so 0 is January) |
| date | [int](../reference.md#type-int) | false | — | date within the month |
...
### Description
Returns a new [Date](../reference.md#object-date) instance, representing the `baseDate` adjusted by the relative amount of the [relativeDateString](../reference_2.md#type-relativedatestring).
...
| rangePosition | [RelativeDateRangePosition](../reference.md#type-relativedaterangeposition) | true | — | optional date-range position. Only has an effect if the date passed in is a [RelativeDateShortcut](../reference.md#type-relativedateshortcut) where the range position is not implicit, such as "$yesterday" |
...
### Description
Returns the [FiscalYear](../reference.md#object-fiscalyear) object for the fiscal year in which the passed date exists.
...
`[FiscalYear](#type-fiscalyear)` — the [FiscalYear](../reference.md#object-fiscalyear) object for the passed date
