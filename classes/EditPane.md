...
### Description
A container that allows drag and drop instantiation of visual components from a [Palette](../main.md#interface-palette), and direct manipulation of the position and size of those components.
...
Can be retrieved at any time. Use [EditPane.getRootEditNode](#method-editpanegetrooteditnode) to retrieve the [EditNode](../main.md#object-editnode) created from the rootComponent.
...
### Description
Additional [Palettes](../main.md#interface-palette) to consult for metadata when deserializing [Edit Nodes](../main.md#object-editnode). Note that the [defaultPalette](#attr-editpanedefaultpalette) is always consulted and need not be provided again here.
...
When enabled, during a drop interaction in which a [PaletteNode](../main.md#object-palettenode) or [EditNode](../main.md#object-editnode) is the drop data, the [Component Schema](../kb_topics/componentSchema.md#kb-topic-component-schema) of the current candidate drop target is inspected to see whether that parent allows children of the type being dropped. If it does, the drop will result in a call to [EditPane.addNode](#method-editpaneaddnode) for a paletteNode or for an existing [EditNode](../main.md#object-editnode) in the same tree.
...
### Description
Creates a [PaletteNode](../main.md#object-palettenode) from an [EditNode](../main.md#object-editnode) in this context's [editNodeTree](#method-editpanegeteditnodetree).
...
### Description
Returns the root [EditNode](../main.md#object-editnode) of the EditContext typically created from [EditPane.rootComponent](#attr-editpanerootcomponent).
...
### Description
Encode the tree of [EditNodes](../main.md#object-editnode) to a JSON representation of [PaletteNodes](../main.md#object-palettenode). The result can be supplied to [addPaletteNodesFromJSON()](#method-editpaneaddpalettenodesfromjson) to recreate the EditNodes.
...
### Description
Recreate [EditNodes](../main.md#object-editnode) from a JSON representation of [PaletteNodes](../main.md#object-palettenode) (possibly created by calling [EditPane.serializeAllEditNodesAsJSON](#method-editpaneserializealleditnodesasjson) or [EditPane.serializeEditNodesAsJSON](#method-editpaneserializeeditnodesasjson).
...
### Description
Serialize the tree of [EditNodes](../main.md#object-editnode) to an XML representation of [PaletteNodes](../main.md#object-palettenode). The result can be supplied to [addPaletteNodesFromXML()](#method-editpaneaddpalettenodesfromxml) to recreate the EditNodes.
...
### Description
Recreate [EditNodes](../main.md#object-editnode) from an XML representation of [PaletteNodes](../main.md#object-palettenode) (possibly created by calling [EditPane.serializeAllEditNodes](#method-editpaneserializealleditnodes) or [EditPane.serializeEditNodes](#method-editpaneserializeeditnodes).
...
### Description
Returns an Array of [PaletteNode](../main.md#object-palettenode)s representing all current [EditNode](../main.md#object-editnode)s in this pane, suitable for saving and restoring via passing each paletteNode to [addNode()](EditContext.md#method-editcontextaddnode).
