...
If no DataSource was explicitly specified, filteredList will automatically generate its own DataSource with [dropUnknownCriteria](DataSource_1.md#attr-datasourcedropunknowncriteria) set to false.
