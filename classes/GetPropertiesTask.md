...
### Description
Gets the value properties from a component and makes them available within the workflow as the [last task output](../reference_2.md#type-taskinputexpression). Using [bindOutput](ProcessElement.md#attr-processelementbindoutput), these values can also be placed into the [process state](Process.md#attr-processstate).
