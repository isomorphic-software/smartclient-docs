...
Rather than using the Layout class directly, use the [HLayout](../reference.md#class-hlayout), [VLayout](../reference.md#class-vlayout), [HStack](../reference.md#class-hstack) and [VStack](../reference.md#class-vstack) classes, which are subclasses of Layout preconfigured for horizontal or vertical stacking, with the "fill" (VLayout) or "none" (VStack) [policies](../reference.md#type-layoutpolicy) already set.
...
- [LayoutPolicy](../reference.md#type-layoutpolicy)
...
### Description
A declared value of the enum type [Orientation](../reference.md#type-orientation).
...
### Description
A declared value of the enum type [LayoutPolicy](../reference.md#type-layoutpolicy).
...
### Description
A Layout may overflow if it has one or more members with a fixed width or height, or that themselves overflow. For details on member sizing see [LayoutPolicy](../reference.md#type-layoutpolicy).
...
Called only for Layouts which have a [layout policy](../reference.md#type-layoutpolicy) for the breadth axis of "fill", since Layouts with a breadth policy of "none" leave all member breadths alone.
