...
### Description
See [ListGridRecord.embeddedComponentPosition](ListGridRecord.md#attr-listgridrecordembeddedcomponentposition), except that when used in a `menuItem`, default behavior is [EmbeddedPosition](../reference.md#type-embeddedposition) "expand".
...
May be defined as a [stringMethod](../reference.md#kb-topic-string-methods-overview).
...
`[SCImgURL](../reference_2.md#type-scimgurl)` — the url of this menuItems icon
...
| Name | Type | Optional | Default | Description |
|------|------|----------|---------|-------------|
| target | [Canvas](#type-canvas) | false | — | for a menu shown as a context menu, the Canvas the menu was shown on. Otherwise the [Menu](Menu.md#class-menu) instance of which this [MenuItem](../reference.md#object-menuitem) is a member. |
| item | [MenuItem](#type-menuitem) | false | — | The [MenuItem](../reference.md#object-menuitem) that was clicked on. |
| menu | [Menu](#type-menu) | false | — | The [Menu](Menu.md#class-menu) instance of which this [MenuItem](../reference.md#object-menuitem) is a member. |
