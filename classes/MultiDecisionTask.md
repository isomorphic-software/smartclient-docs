...
### Description
List of [DecisionBranchs](../main_2.md#object-decisionbranch) to be processed to find the first with matching criteria. The specified [DecisionBranch.targetTask](DecisionBranch.md#attr-decisionbranchtargettask) is then used to identify the the next element.
