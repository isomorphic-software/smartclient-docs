...
### Description
Returns the selected nodes in this grid as a list of [NodeLocator](../main_2.md#object-nodelocator)s.
...
### Description
Deselect a particular node occurence. Note if you do not pass a [NodeLocator](../main_2.md#object-nodelocator), the recordNum parameter is required.
...
| recordNum | [Integer](../main_2.md#type-integer) | true | — | Optional index into the underlying Tree's openList (which will be the same as the record number in a [TreeGrid](TreeGrid.md#class-treegrid)). Required if the "node" param is not a NodeLocator |
...
### Description
Select a particular node occurence. Note if you do not pass a [NodeLocator](../main_2.md#object-nodelocator), the recordNum parameter is required.
...
### Description
Select a single node occurence and deselect everything else. Note if you do not pass a [NodeLocator](../main_2.md#object-nodelocator), the recordNum parameter is required.
