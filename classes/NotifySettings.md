...
### Description
Space between each message when [MultiMessageMode](../reference.md#type-multimessagemode) is "stack".
...
### Description
Determines what happens if a message appears while there's still another one of the same [NotifyType](../reference.md#type-notifytype) being shown. Such messages are either stacked or replace one another,
...
*   [Notify.ERROR](Notify.md#classattr-notifyerror) for [NotifyType](../reference.md#type-notifytype): "error",
*   [Notify.WARN](Notify.md#classattr-notifywarn) for [NotifyType](../reference.md#type-notifytype): "warn", and
*   [Notify.MESSAGE](Notify.md#classattr-notifymessage) for all other [NotifyType](../reference.md#type-notifytype)s
...
*   [NotifyType](../reference.md#type-notifytype): "error" for priority [Notify.ERROR](Notify.md#classattr-notifyerror),
*   [NotifyType](../reference.md#type-notifytype): "warn" for priority [Notify.WARN](Notify.md#classattr-notifywarn), or
*   [NotifyType](../reference.md#type-notifytype): "message" for priorities at or below [Notify.MESSAGE](Notify.md#classattr-notifymessage) (greater or equal numerically)
...
*   "notifyError" for [NotifyType](../reference.md#type-notifytype): "error",
*   "notifyWarn" for [NotifyType](../reference.md#type-notifytype): "warn", and
*   "notifyMessage" for all other [NotifyType](../reference.md#type-notifytype)s.
...
### Description
Whether to default properties affecting the message appearance to those of the built-in [NotifyType](../reference.md#type-notifytype) corresponding to the [messagePriority](#attr-notifysettingsmessagepriority). Default is true except for [NotifyType](../reference.md#type-notifytype)s "error" and "warn", which default to false.
...
### Description
Determines how messages are stacked if [MultiMessageMode](../reference.md#type-multimessagemode) is "stack". For example, "down" means that older messages move down when a new message of the same [NotifyType](../reference.md#type-notifytype) appears.
...
*   "notifyErrorActionLink" for [NotifyType](../reference.md#type-notifytype): "error",
*   "notifyWarnActionLink" for [NotifyType](../reference.md#type-notifytype): "warn", and
*   "notifyMessageActionLink" for all other [NotifyType](../reference.md#type-notifytype)s.
...
*   "\[SKIN\]/Notify/error.png" for [NotifyType](../reference.md#type-notifytype): "error",
*   "\[SKIN\]/Notify/warning.png" for [NotifyType](../reference.md#type-notifytype): "warn", and
*   "\[SKIN\]/Notify/checkmark.png" for all other [NotifyType](../reference.md#type-notifytype)s.
...
### Description
Controls how older messages' [NotifySettings.duration](#attr-notifysettingsduration) countdowns are affected when a new message of the same [NotifyType](../reference.md#type-notifytype) appears. We either continue the countdowns on the older messages as if they are unrelated, or we reset any countdowns that are less than the new message's `duration`.
...
### Description
Sets a limit on how many messages may be stacked if [MultiMessageMode](../reference.md#type-multimessagemode) is "stack". The oldest message of the affected [NotifyType](../reference.md#type-notifytype) will be dismissed to enforce this limit.
