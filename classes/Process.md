...
### Description
Sets the task output of `task` in the [process state](../reference.md#type-state) so it can be used by later tasks with [Process.getLastTaskOutput](#method-processgetlasttaskoutput) or more commonly with a [taskInputExpression](../kb_topics/taskInputExpression.md#kb-topic-task-input-expressions) property.
...
### Description
Sets a [process state](#attr-processstate) variable for later reference with [Process.getStateVariable](#method-processgetstatevariable) or more commonly with a [taskInputExpression](../kb_topics/taskInputExpression.md#kb-topic-task-input-expressions) property.
...
| Name | Type | Optional | Default | Description |
|------|------|----------|---------|-------------|
| nextElement | [String](#type-string) | true | — | ID of the next task execute or null to terminate process |

---
## Method: Process.getLastTaskOutput

### Description
Returns the task output of the last task executed. More commonly a [taskInputExpression](../kb_topics/taskInputExpression.md#kb-topic-task-input-expressions) property is used (see [ProcessElement.getDynamicValue](ProcessElement.md#method-processelementgetdynamicvalue)).
