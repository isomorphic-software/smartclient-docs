...
### Description
Limits the range of the popup [DateChooser](DateChooser.md#class-datechooser). The default of null causes the chooser's Year-picker to offer a range that ends 10 years after the current selection.
...
### Description
Limits the range of the popup [DateChooser](DateChooser.md#class-datechooser). The default of null causes the chooser's Year-picker to offer a range that starts 10 years before the current selection.
