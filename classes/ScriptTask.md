...
An asynchronous task is expected to start processing in execute(), and will not be considered complete until either [ScriptTask.setOutputData](#method-scripttasksetoutputdata) or [ScriptTask.setOutputRecord](#method-scripttasksetoutputrecord) is called.
