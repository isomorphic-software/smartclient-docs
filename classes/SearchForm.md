...
### Description
For [SearchForms](#class-searchform) and [Items in a filterEditor](ListGrid_1.md#attr-listgridshowfiltereditor), what formItem should be used to display large set of options to the user?

This property is consulted when generating the item for a field with a valueMap containing more options than the [SearchForm.largeValueMapFilterEditorThreshold](#attr-searchformlargevaluemapfiltereditorthreshold). It is also consulted if the item derives its options from an [optionDataSource](FormItem.md#attr-formitemoptiondatasource).

Note that if the [DynamicForm.dataSource](DynamicForm.md#attr-dynamicformdatasource) does not support the [criterion.operator](../reference.md#type-operatorid) generated by this editor, the editor will not be used. This may occur with the default [SetFilterItem](SetFilterItem.md#class-setfilteritem) if the dataSource does not support `inSet` and `notInSet` criteria.
...
### Description
For [SearchForms](#class-searchform) and [Items in a filterEditor](ListGrid_1.md#attr-listgridshowfiltereditor) this property governs the threshold for how many entries are in a [FormItem.valueMap](FormItem.md#attr-formitemvaluemap) before the [SearchForm.largeValueMapFilterEditorType](#attr-searchformlargevaluemapfiltereditortype) is displayed.
