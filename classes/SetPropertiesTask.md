...
### Description
Gets the value properties from a component and makes them available within the workflow as the [last task output](../kb_topics/taskInputExpression.md#kb-topic-task-input-expressions).
