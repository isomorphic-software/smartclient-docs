...
### Description
Map from the all-capital letter names used as summary variables in the [UserSummary](../reference.md#object-usersummary) String to the fieldNames these variables should represent in the context where the summary is evaluated.
