...
### Description
A DataSource preconfigured to use the ["scriptInclude"](../main.md#type-rpctransport) transport (sometimes called "JSONP") for cross-domain calls to JSON services.
