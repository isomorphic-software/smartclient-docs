...
For DataSources of [type](../reference_2.md#type-dsservertype) `"sql"` or `"hibernate"`, the buttons at the bottom of this tab allow users to create a new database table for the DataSources. Test data may be imported test data, either from an existing [test data file](../classes/DataSource_1.md#attr-datasourcetestdata) or by uploading [CSV, JSON or XML formatted data](testData.md#kb-topic-test-data).
