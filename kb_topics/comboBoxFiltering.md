...
### Description
The criteria used to decide which options should appear in the drop-down [PickList](../main_2.md#interface-picklist) shown by a ComboBox are determined as follows.
