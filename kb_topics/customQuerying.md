...
In SQL dataSources, you also have access to the [default subclauses](../main.md#type-defaultqueryclause) generated by SmartClient. You can use these in full custom queries to allow a certain part of the query code to be generated:
...
The above examples involving $criteria assume that the submitted criteria are simple Criteria and not [AdvancedCriteria](../main.md#object-advancedcriteria), a more sophisticated criteria format in which different search operators can be specified per field and criteria can be nested.
...
- [DefaultQueryClause](../main.md#type-defaultqueryclause)
- [SQLType](../main_2.md#type-sqltype)
