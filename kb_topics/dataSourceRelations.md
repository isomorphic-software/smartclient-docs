...
### Description
Properties for declaring relations between DataSources and within DataSources, such as master-detail relationships (a SalesOrder contains 0 or more OrderItems) and tree relationships (records can be linked by a parentId field).
