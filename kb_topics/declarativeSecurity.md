...
Requests that fail to pass Declarative Security checks will return response with [special status set](../classes/RPCResponse.md#classattr-rpcresponsestatus_authorization_failure).
