...
For example, if [your bean](../classes/DataSource_1.md#attr-datasourcebeanclassname) has a field "price" of type Float, an "update" DSRequest with a new value for this field will use the Java Float type for the new value, whereas in the absence of a bean, the Double type would ordinarily be used (see [RPCRequest.data](../classes/RPCRequest.md#attr-rpcrequestdata)).
