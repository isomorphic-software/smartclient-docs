...
### Description
Various subsystems have a need to compare DataSource requests and understand if they are equivalent or affect the same data (examples include [automatic cache synchronization](../classes/ResultSet.md#class-resultset) and [offline caching and synchronization](../classes/DataSource_1.md#attr-datasourceuseofflinestorage)).
...
[DataSource.cloneDSRequest](../classes/DataSource_1.md#method-datasourceclonedsrequest) can be used to create an equivalent DSRequest.
