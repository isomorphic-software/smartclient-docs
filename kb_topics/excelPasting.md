...
### Description
[DataSource.recordsAsText](../classes/DataSource_2.md#method-datasourcerecordsastext) can export a set of DataSource records in tab-separated-values format so that it can be copied and pasted into a Microsoft Excel spreadsheet.
...
The first or second approach can be enabled when exporting text - see [DataSource.recordsAsText](../classes/DataSource_2.md#method-datasourcerecordsastext) and [DataSourceField.exportForceText](../classes/DataSourceField.md#attr-datasourcefieldexportforcetext).
