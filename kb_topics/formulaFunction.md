...
The following functions are available to provide equivalent functionality for [clientOnly](../classes/DataSource_1.md#attr-datasourceclientonly) dataSources. Nte that the database support information is for reference only - we recommend consulting your database's official documentation for definitive details of the functions available to you.
