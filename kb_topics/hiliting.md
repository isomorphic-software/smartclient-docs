...
Hiliting rules such as hiliting different ranges of values with different colors can be accomplished entirely client-side by defining [AdvancedCriteria](../main.md#object-advancedcriteria) in hilite definitions that pick out values to be highlighted.
...
- [HiliteIconPosition](../main_2.md#type-hiliteiconposition)
...
- [Hilite](../main_2.md#object-hilite)
