...
```
Or, if you have the [Network Performance](networkPerformance.md#kb-topic-network-performance), you can use the [FileLoader.loadLocale](../classes/FileLoader.md#staticmethod-fileloaderloadlocale)/[FileLoader.cacheLocale](../classes/FileLoader.md#staticmethod-fileloadercachelocale) APIs:
```
...
*   JSTL home page: [http://java.sun.com/products/jsp/jstl/](http://java.sun.com/products/jsp/jstl/)
*   Apache JSTL "Getting Started": [http://jakarta.apache.org/taglibs/doc/standard-doc/standard/GettingStarted.html](http://jakarta.apache.org/taglibs/doc/standard-doc/standard/GettingStarted.html)
*   Apache taglibs: [http://jakarta.apache.org/taglibs/](http://jakarta.apache.org/taglibs/)

**.NET**

*   MSDN Developer Resource: "Developing World-Ready Applications": [http://msdn.microsoft.com/library/default.asp?url=/library/en-us/cpguide/html/cpcondesigningglobalapplications.asp](http://msdn.microsoft.com/library/default.asp?url=/library/en-us/cpguide/html/cpcondesigningglobalapplications.asp)

**PHP**

*   PHP Gettext manual: [http://us2.php.net/gettext](http://us2.php.net/gettext)
*   O'Reilly Gettext tutorial: [http://www.onlamp.com/pub/a/php/2002/06/13/php.html](http://www.onlamp.com/pub/a/php/2002/06/13/php.html)

**Perl**

*   Perl, Unicode and i18n FAQ: [http://rf.net/~james/perli18n.html](http://rf.net/~james/perli18n.html)
