...
The following [search operators](../main.md#object-operator) are supported with the behaviors listed below. For simple Criteria, criteria values are treated identically to the "equals" operator and the [textMatchStyle](../classes/DSRequest.md#attr-dsrequesttextmatchstyle) is ignored.
