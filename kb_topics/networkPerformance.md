...
_Note that in addition to these network performance considerations, you should also be aware of the recommended application design practices discussed in [smartArchitecture](smartArchitecture.md#kb-topic-smartclient-architecture)._

There are three main ways of improving the performance of your application:

**Compression**

You'll want to deliver as much of your application assets compressed as possible. For a start, the SmartClient modules come pre-compressed. The [compression](compression.md#kb-topic-compression) section describes how to make sure that SmartClient modules and your application logic are delivered compressed and how to enable dynamic compression of your dynamic content.
