...
Suppose you've created a screen in Reify that you want to load into your React app. You can do it via [Reify.loadProject](../classes/Reify.md#method-reifyloadproject) as in this sample:
