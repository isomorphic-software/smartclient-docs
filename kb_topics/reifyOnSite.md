...
With Reify OnSite, custom workflow tasks and associated editors can be added to support your special project needs. See [reifyAddWorkflowTask](reifyAddWorkflowTask.md#kb-topic-adding-custom-workflow-tasks) for details.
