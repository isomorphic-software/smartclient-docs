...
*   [Velocity-based](#kb-topic-velocitysupport) templates providing powerful declarative data templating and conversion for both [requests](../classes/DataSource.md#attr-datasourcerequesttemplate) and [responses](../classes/DataSource.md#attr-datasourceresponsetemplate). These templates are evaluated at request/response execution time, so can include dynamic elements such as the criteria sent from the client
