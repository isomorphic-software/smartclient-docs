...
*   CSS is used to control details of appearance such as fonts, borders and background colors and gradients, but component properties are used to control layout and positioning of components. See [CSSStyleName](../reference_2.md#type-cssstylename) for more details about correct usage.
*   A "skin" consists of:
