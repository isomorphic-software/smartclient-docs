...
*   [Automatic transaction management](../classes/DataSource_1.md#attr-datasourceautojointransactions)
...
You can connect to an existing database table by providing a [DataSource.tableName](../classes/DataSource_1.md#attr-datasourcetablename) attribute value. Field-level details can be provided explicitly, if you choose, or these can be automatically inferred from your schema via [DataSource.autoDeriveSchema](../classes/DataSource_1.md#attr-datasourceautoderiveschema). **With autoDeriveSchema, you get full SQL connectivity / generation from a one-line .ds.xml file!.** You can of course customize these automatically derived field definitions without having to reiterate the properties discovered by auto-derivation. For example, the following field definition overrides an automatically [derived title](../classes/DataSource_1.md#attr-datasourceautoderivetitles) while preserving metadata obtained from the table, such as type & length:
