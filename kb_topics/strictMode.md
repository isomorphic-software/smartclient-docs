...
### Description
Enabling "strict mode" means that any attributes in a [Component XML](componentXML.md#kb-topic-component-xml) file which are not declared in [Component Schema](../main.md#class-componentschema) will cause warnings in the server-side log.
