...
The [TreeGrid.showDropIcons](../classes/TreeGrid.md#attr-treegridshowdropicons) and [ListGrid.showDropLines](../classes/Layout.md#attr-layoutshowdroplines) enable customization of the grid appearance during drag interactions.
